    ...
    <>
      <div className="container mb-5" style={{ margin: 'auto', width: '80%' }}>
        ...
        <div className="row mt-5 mb-3">
          ...
          {eyeglassesImages.map((img, index) => (
        ...
        <div className="row mt-5 pt-2">
          ...
          {sunglassesImages.map((img, index) => (
            <div key={index} className="col-12 col-sm-6 col-md-4 mb-4">
              <Link to="/product">
                <img
                  src={img}
      ...
      <script>
        const eyeglassesImages = [
        `${process.env.PUBLIC_URL}/images/eyeglass1.jpg`,
        `${process.env.PUBLIC_URL}/images/eyeglass2.jpg`,
        `${process.env.PUBLIC_URL}/images/eyeglass3.jpg`
        ];

        const sunglassesImages = [
        `${process.env.PUBLIC_URL}/images/sunglass1.jpg`,
        `${process.env.PUBLIC_URL}/images/sunglass2.jpg`,
        `${process.env.PUBLIC_URL}/images/sunglass3.jpg`
        ];
