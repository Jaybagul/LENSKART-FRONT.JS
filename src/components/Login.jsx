        ...
        <>
            <div className="container mt-0 p-0 mb-3">
                <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-8 mt-xl-5 " style={{ borderRadius: '25px', border: "1px solid grey", backgroundColor: "white" }}>
                        ...
                        <div className="mt-3">
                            <p style={{ display: "block", textAlign: "center", color: 'black' }}>New member? <a href="#" className='tect-center'>Create an Account</a></p>
                        </div>
                    </div>
                </div>
            </div>
